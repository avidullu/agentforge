...
| AF-012 | PII redaction S4: tests/tool swap to synthetic fixtures; rename demo tool; remove display name / machine hint | **IN PROGRESS** | AF-011 | branch `af-012-synthetic-test-fixtures` |
