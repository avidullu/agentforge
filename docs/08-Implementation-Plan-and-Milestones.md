...
| AF-012 | PII redaction S4: tests/tool swap to synthetic fixtures; rename demo tool; remove display name / machine hint | **IN REVIEW** | AF-011 | [Forgejo #14](https://avis-pbook.tail651ec3.ts.net/avidullu/agentforge/pulls/14) · [`04c0afe`](https://github.com/avidullu/agentforge/commit/04c0afe) |
