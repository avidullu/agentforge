...
| AF-012 | PII redaction S4: tests/tool swap to synthetic fixtures; rename demo tool; remove display name / machine hint | **SHIPPED** | AF-011 | [Forgejo #14](https://avis-pbook.tail651ec3.ts.net/avidullu/agentforge/pulls/14) merged as [`e5bec35`](https://github.com/avidullu/agentforge/commit/e5bec354420c) · tip [`6dbe856`](https://github.com/avidullu/agentforge/commit/6dbe856e2260) |
